...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (true) module.exports = factory();else if (typeof define === "function" && define.amd) define(factory);else if (typeof exports === "object") exports.grid = factory();else root.grid = factory();
	})(undefined, function () {
		return ((function (modules) {
				...
				module.exports = function () {
					var T = new H.Template({ code: function code(c, p, i) {
							var t = this;t.b(i = i || "");t.b("<tr data-id=\"");t.b(t.v(t.f("id", c, p, 0)));t.b("\" class=\"grid-row\">\r");t.b("\n" + i);if (t.s(t.f("cells", c, p, 1), c, p, 0, 51, 140, "{{ }}")) {
								t.rs(c, p, function (c, p, t) {
									t.b("\t\t<td class=\"grid-cell ");t.b(t.v(t.f("cls", c, p, 0)));t.b("\"><span class=\"grid-cell-inner\">");t.b(t.t(t.f("text", c, p, 0)));t.b("</span></td>\r");t.b("\n" + i);
								});c.pop();
							}t.b("</tr>");return t.fl();
						}, partials: {}, subs: {} }, "<tr data-id=\"{{id}}\" class=\"grid-row\">\r\n\t{{#cells}}\r\n\t\t<td class=\"grid-cell {{cls}}\"><span class=\"grid-cell-inner\">{{{text}}}</span></td>\r\n\t{{/cells}}\r\n</tr>", H);return T.render.apply(T, arguments);
				};
			}, function (module, exports, __webpack_require__) {
				...
				module.exports = function () {
					var T = new H.Template({ code: function code(c, p, i) {
							var t = this;t.b(i = i || "");t.b("<td class=\"");t.b(t.v(t.f("headerCls", c, p, 0)));t.b("\" data-sortby=\"");t.b(t.v(t.f("field", c, p, 0)));t.b("\">\r");t.b("\n" + i);t.b("\t");if (t.s(t.f("sortable", c, p, 1), c, p, 0, 66, 92, "{{ }}")) {
								t.rs(c, p, function (c, p, t) {
									t.b("<i class=\"fa fa-sort\"></i>");
								});c.pop();
							}t.b("\r");t.b("\n" + i);t.b("\t<span class=\"grid-header-cell-inner\">");t.b(t.v(t.f("name", c, p, 0)));t.b("</span>\r");t.b("\n" + i);t.b("</td>");return t.fl();
						}, partials: {}, subs: {} }, "<td class=\"{{headerCls}}\" data-sortby=\"{{field}}\">\r\n\t{{#sortable}}<i class=\"fa fa-sort\"></i>{{/sortable}}\r\n\t<span class=\"grid-header-cell-inner\">{{name}}</span>\r\n</td>", H);return T.render.apply(T, arguments);
				};
			}, function (module, exports, __webpack_require__) {
